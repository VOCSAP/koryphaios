...
| 🏺 Docker | Sandbox mode: run this project's sessions inside a persistent Docker/Podman container (see [sandbox.md](sandbox.md)). The jar fills amber when the shared auth volume has no Claude credentials — agents cannot spawn until you sign in |
