...
export const EN_DEFAULTS: Record<string, string> = {
  ...
  'settings.supervisorAgent': 'Supervisor agent profile',
  'settings.supervisorAgentNone': 'built-in briefing only',
  'settings.supervisorAgentHelp':
    'Agent profile (from .claude/agents) the Home supervisor launches with, layered over its built-in briefing. Applied on the next supervisor start.',
  'nav.agents': 'Agents',
  'nav.roadmap': 'Roadmap',
