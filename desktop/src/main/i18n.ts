...
export const EN_DEFAULTS: Record<string, string> = {
  ...
  'settings.catRules': 'Rules',
  'rules.eventPre': 'Before the tool runs',
  'rules.eventPost': 'After the tool runs',
  'rules.sourceKory': 'Kory',
  'rules.sourceGlobal': 'Global',
  'rules.sourceRepo': 'Repo',
  'rules.view': 'View',
  'rules.edit': 'Edit',
  'rules.colName': 'Name',
  'rules.colHook': 'Hook',
  'rules.colDefinition': 'Definition',
  'rules.colActive': 'Active',
  'rules.badgePending': 'needs approval',
  'rules.badgeInvalid': 'invalid',
  'rules.loadError': 'Could not load the guard rules.',
  'rules.retry': 'Retry',
  'rules.loading': 'Loading the guard rules…',
  'rules.approveStale': 'The file changed since it was read; the list has been refreshed.',
  'rules.korySection': 'Kory rules',
  'rules.globalSection': 'Global rules',
  ...
  'rules.deleteConfirmMessage': 'This removes "{id}" from the file. This cannot be undone.',
  'rules.modalTitleView': 'View rule',
  'rules.modalTitleAdd': 'Add a rule',
  'rules.modalTitleEdit': 'Edit rule',
  'rules.fieldId': 'Id',
  'rules.fieldEvent': 'Event',
  'rules.fieldTools': 'Tools',
  'rules.fieldField': 'Field',
  'rules.fieldPaths': 'Paths (one glob per line, "!" to exclude)',
  'rules.fieldPathsHelp': 'Relative to the project root. Leave empty to match every path.',
  'rules.fieldPattern': 'Pattern (regex)',
  'rules.fieldFlags': 'Flags',
  'rules.fieldMode': 'Mode',
  'rules.fieldMessage': 'Message',
  'rules.messageCounter': '{count}/{max} characters',
  'rules.modeDeny': 'Deny',
  'rules.modeWarn': 'Warn',
  'rules.testTitle': 'Test',
  'rules.testSampleText': 'Sample text',
  'rules.testFilePath': 'File path (optional)',
  'rules.testRun': 'Test',
  'rules.testTimedOut': 'Timed out — the pattern may be catastrophically slow.',
  'rules.testMatch': 'Matches',
  'rules.testNoMatch': 'Does not match',
  'rules.testPathNotMatched': 'path not matched',
