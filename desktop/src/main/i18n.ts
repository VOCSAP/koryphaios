...
export const EN_DEFAULTS: Record<string, string> = {
  ...
  'banner.replicaOffline': 'Upstream broker unreachable — working offline, {count} change(s) pending',
  ...
  'settings.brokerModeHelp': 'Derived from the claude-peers configuration file shared with the agent sessions and the CLI; the environment variables below override it.',
